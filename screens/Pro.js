        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={45}>Funcionalidad</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>NO</Text>
                </Block>
                <Block row>
                  <Text color="white" size={45}>implementada</Text>
              ...
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                Esta es una característica que aún no está implementada, ya que es solo un prototipo de la versión final para iOS y Android.
              </Text>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>Regresar</Text>
              </Button>
            </Block>
          </Block>
        </Block>
